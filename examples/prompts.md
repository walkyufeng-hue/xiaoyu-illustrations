...
```text
Use $xiaoyu-illustrations 给这篇长文做配图策略。
...
```text
Use $xiaoyu-illustrations 为这个观点生成一张 16:9 正文配图：
...
```text
Use $xiaoyu-illustrations 为"把一条原始素材加工成流量、信任、转化三种内容"生成一张图。
不要画正式流程图，不要复刻一鱼多吃旧案例。
请重新发明一个新的低科技隐喻，让小玉参与核心动作。
```

## 改图：去掉标题

```text
Use $xiaoyu-illustrations 帮我编辑这张图。
...
```text
Use $xiaoyu-illustrations 这张图方向对，但小玉有点像装饰。
请保持核心意思不变，重生成一版：让小玉成为真正推动结构运转的人。
画面更有速写灵气，但仍然干净、清爽、少字。
```

## 生成一组风格样片

```text
Use $xiaoyu-illustrations 输出 5 个不同主题的小玉正文配图效果。
