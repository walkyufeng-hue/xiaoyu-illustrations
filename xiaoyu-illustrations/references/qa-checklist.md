...
- 是 16:9 横版。
- 背景是干净白底或接近透明，允许极淡自然投影，不要有复杂场景。
- 有小玉。
- 小玉承担核心动作，不只是装饰。
- 没有复刻已有示例构图，而是为当前文章生成了新隐喻。
- 画面怪诞、有创意、有意思。
- 简洁清爽，主体不超过画面约 60%。
- 一张图只讲一个核心结构。
- 中文标注少、短、能读。
...
如果第一眼像教程页，而不是干净背景上的淡彩手绘速写，就不合格。
